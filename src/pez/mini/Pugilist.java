...
public class Pugilist extends AdvancedRobot {
    ...
    public void onScannedRobot(ScannedRobotEvent e) {
        ...
        double bulletPower = enemyDistance < 175 ? MAX_BULLET_POWER : 1.9;
...
class Wave extends Condition {
    ...
    static final String GW = "" + (char)2 + (char)200 + (char)50 + (char)18 + (char)18 + (char)16 + (char)20;
    static final String SW = "" + (char)2 + (char)200 + (char)50 + (char)18 + (char)18 + (char)16 + (char)1;
