...
class Wave extends Condition {
    ...
    static final String GW = "" + (char)10 + (char)2000 + (char)500 + (char)180 + (char)180 + (char)160 + (char)200;
    static final String SW = "" + (char)10 + (char)2000 + (char)500 + (char)180 + (char)180 + (char)160 + (char)10;
