...
class Wave extends Condition {
    ...
    static final String GW = "" + (char)1 + (char)200 + (char)50 + (char)18 + (char)18 + (char)8 + (char)20;
    static final String SW = "" + (char)1 + (char)200 + (char)50 + (char)18 + (char)18 + (char)8 + (char)1;
