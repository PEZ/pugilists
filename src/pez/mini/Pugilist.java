...
public class Pugilist extends AdvancedRobot {
    ...
    public void onScannedRobot(ScannedRobotEvent e) {
        ...
        ew.initObs(enemyFirePower, robotVelocity, prevRobotVelocity, robotLocation, direction, enemyLocation, robotTSVC,
                getVelocity() * Math.cos(getHeadingRadians() - ew.startBearing));
        ...
        wave.initObs(bulletPower, enemyVelocity, prevEnemyVelocity, enemyLocation, enemyBearingDirection,
                ...
                enemyVelocity * Math.cos(e.getHeadingRadians() - enemyAbsoluteBearing));
...
class Wave extends Condition {
    ...
    void initObs(double power, double vel, double prevVel, Point2D loc, double direction, Point2D orbitCenter, int tSVC, double ar) {
        ...
        obs = new double[] { 0, Pugilist.enemyDistance, prevVel - vel,
            ...
            Pugilist.wallSmooth(orbitCenter, loc, direction), tSVC, ar };
    }
