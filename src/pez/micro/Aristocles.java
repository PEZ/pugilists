...
public class Aristocles extends AdvancedRobot {
	...
	static int[][][][] aimFactors = new int[DISTANCE_INDEXES][LAST_VELOCITY_INDEXES][DECCEL_TIME_INDEXES][AIM_FACTORS];
	...
	public void onScannedRobot(ScannedRobotEvent e) {
		...
		wave.wAimFactors = aimFactors[distanceIndex][lastVelocityIndex][Math.min(5, timeSinceDeccel++ / 13)];
